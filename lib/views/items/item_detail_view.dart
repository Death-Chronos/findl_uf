...
class _ItemDetailsViewState extends State<ItemDetailsView> {
  ...
  Future<void> _openWhatsApp() async {
    ...
    final String phone = _userProfile!.telefone.replaceAll(RegExp(r'[^\d]'), '');
    final String statusText = widget.item.status == ItemStatus.lost ? 'perdeu' : 'achou';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                radius: 24,
                                backgroundImage: _userProfile!.fotoUrl.isNotEmpty
                                    ? NetworkImage(_userProfile!.fotoUrl)
                                    : null,
                                child: _userProfile!.fotoUrl.isEmpty
      ...
      bottomNavigationBar: _userProfile != null
          ? SafeArea(
              child: Padding(
                padding: const EdgeInsets.all(16.0),
