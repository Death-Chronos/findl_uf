...
import 'package:findl_uf/supabase.dart';
import 'package:findl_uf/views/auth/complete_profile_view.dart';
import 'package:findl_uf/views/auth/forgot_password_view.dart';
import 'package:findl_uf/views/auth/login_view.dart';
import 'package:findl_uf/views/auth/register_view.dart';
import 'package:findl_uf/views/auth/reset_password_view.dart';
import 'package:findl_uf/views/auth/verify_email_view.dart';
import 'package:findl_uf/views/home_view.dart';
import 'package:findl_uf/views/items/create_update_lost_and_found_item_view.dart';
import 'package:findl_uf/views/items/item_detail_view.dart';
import 'package:findl_uf/views/profile/change_password_view.dart';
